...
async def handle_echo(reader, writer):
	...
	while(True):
		...
		#login 
		if data[13] == ord('0'): 
			payload = b'/0\x10\x00\x00\x00\x20\x00\x00\x00\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05'
		...
		# contacts
			...
			payload = b'/2\x10\x00\x00\x00\x20\x00\x00\x00\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05\x01\x02\x03\x04\x05'+ \
